            ...
            <p>
                  <xref target="N">
                   ...
                   <xref target="note1">
                      <span class="citefig">
                         <span class="fmt-element-name">Figure</span>
                         <semx element="autonum" source="note1">1 a)</semx>
                      </span>
                   </xref>
                   <xref target="note2">
                      <span class="citefig">
                         <span class="fmt-element-name">Figure</span>
                         <semx element="autonum" source="note2">1 b)</semx>
                      </span>
                   </xref>
                   <xref target="AN">
                      <span class="citefig">
                   ...
                   <xref target="Anote1">
                      <span class="citefig">
                         <span class="fmt-element-name">Figure</span>
                         <semx element="autonum" source="Anote1">A.1 a)</semx>
                      </span>
                   </xref>
                   <xref target="Anote2">
                      <span class="citefig">
                         <span class="fmt-element-name">Figure</span>
                         <semx element="autonum" source="Anote2">A.1 b)</semx>
                      </span>
                   </xref>
            </p>
          </foreword>
            ...
            <p id='A'>
              This is a preamble
                   ...
                   <xref target="Q3">
                      ...
                      <span class="fmt-comma">,</span>
                      <span class="fmt-element-name">Appendix</span>
                      <semx element="autonum" source="Q3">1.1</semx>
                   </xref>
                   <xref target="R">
                      <span class="citesec">
                         <span class="fmt-element-name">Clause</span>
      ...
      <iso-standard xmlns='http://riboseinc.com/isoxml' type='presentation'>
           ...
           <foreword obligation="informative" displayorder="2">
             ...
             <p id="A">This is a preamble
                    ...
                    <xref target="D">
                       <span class="citesec">
                          <semx element="autonum" source="D">1.1</semx>
                       </span>
                    </xref>
                    <xref target="T">
                       <span class="citesec">
                          <semx element="autonum" source="T">1.2</semx>
                       </span>
                    </xref>
                    <xref target="H">
                       <span class="citesec">
                          <semx element="autonum" source="H">1.3</semx>
                       </span>
                    </xref>
                    <xref target="I">
                       <span class="citesec">
                          <semx element="autonum" source="I">1.3.1</semx>
                       </span>
                    </xref>
                    <xref target="J">
                       <span class="citesec">
                          <semx element="autonum" source="J">1.3.1.1</semx>
                       </span>
                    </xref>
                    <xref target="K">
                       <span class="citesec">
                          <semx element="autonum" source="K">1.3.2</semx>
                       </span>
                    </xref>
                    <xref target="L">
                       <span class="citesec">
                          <semx element="autonum" source="L">1.4</semx>
                       </span>
                    </xref>
                    <xref target="M">
                       <span class="citesec">
                          <semx element="autonum" source="M">1.5</semx>
                       </span>
                    </xref>
                    <xref target="N">
                       <span class="citesec">
                          <semx element="autonum" source="N">1.5.1</semx>
                       </span>
                    </xref>
                 </p>
           </foreword>
