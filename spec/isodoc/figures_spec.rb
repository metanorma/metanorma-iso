...
RSpec.describe IsoDoc do
  it "renders figures" do
    ...
    expect(Nokogiri::HTML5(output).at("//body").to_xml)
  ...
  it "renders subfigures" do
    ...
    word = <<~OUTPUT
      ...
      <head> <meta content="text/html; charset=UTF-8" http-equiv="Content-Type"/> <style></style> <style></style></head>
        <body lang="EN-US" link="blue" vlink="#954F72">
               <div class="WordSection1">
                  <p> </p>
               </div>
  ...
  it "processes units statements in figures" do
    ...
    expect(strip_guid(Nokogiri::HTML5(output).at("//body").to_xml))
      .to be_xml_equivalent_to word
  end
