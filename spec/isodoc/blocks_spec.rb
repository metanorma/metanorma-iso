...
RSpec.describe IsoDoc do
  ...
  it "renders subfigures (HTML)" do
    output = IsoDoc::Iso::HtmlConvert.new({})
      .convert("test", <<~INPUT, true)
        <iso-standard xmlns='http://riboseinc.com/isoxml'>
          <preface>
            <foreword id='fwd' displayorder="1"><fmt-title id="_">Foreword</fmt-title>
              <p>
                <fmt-xref target='N'/>
          ...
          <sections>
            ...
            <clause id='widgets' displayorder="3">
              ...
              <clause id='widgets1'>
                <figure id='N'>
                  <fmt-name id="_">Figure 1</fmt-name>
                  <figure id='note1'>
                    <fmt-name id="_">a)&#xA0;&#x2014; Split-it-right sample divider</fmt-name>
                    <image src='rice_images/rice_image1.png' id='_8357ede4-6d44-4672-bac4-9a85e82ab7f0' mimetype='image/png'/>
                  </figure>
                  <figure id='note2'>
                    <fmt-name id="_">b)&#xA0;&#x2014; Split-it-right sample divider</fmt-name>
                    <image src='rice_images/rice_image1.png' id='_8357ede4-6d44-4672-bac4-9a85e82ab7f0' mimetype='image/png'/>
                  </figure>
                </figure>
                <p>
          ...
          <annex id='annex1' displayorder="4">
            ...
            <clause id='annex1b'>
              <figure id='AN'>
                <fmt-name id="_">Figure A.1</fmt-name>
                <figure id='Anote1'>
                  <fmt-name id="_">a)&#xA0;&#x2014; Split-it-right sample divider</fmt-name>
                  <image src='rice_images/rice_image1.png' id='_8357ede4-6d44-4672-bac4-9a85e82ab7f0' mimetype='image/png'/>
                </figure>
  ...
  it "processes formulae with single definition list entry" do
    ...
    expect(Canon.format_xml(strip_guid(pres_output)))
      .to be_equivalent_to Canon.format_xml(presxml)
    expect(Canon.format_xml(strip_guid(pres_output))).to be_equivalent_to Canon.format_xml(presxml)
    output = IsoDoc::Iso::HtmlConvert.new({})
      .convert("test", pres_output, true)
    expect(Canon.format_xml(strip_guid(output))).to be_equivalent_to Canon.format_xml(html)
  end
