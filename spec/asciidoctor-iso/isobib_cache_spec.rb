...
RSpec.describe Asciidoctor::ISO do
  ...
  it "fetches uncached references" do
    system "mv ~/.relaton-bib.json ~/.relaton-bib.json1"
    command = %(echo '{"ISO 123":{"fetched":"#{Date.today}","bib":"<bibitem type=\\"international-standard\\" id=\\"ISO123\\">  <title format=\\"text/plain\\" language=\\"en\\" script=\\"Latn\\">Rubber latex -- Sampling</title><docidentifier>ISO 123</docidentifier></bibitem>"}}' > ~/.relaton-bib.json)
    system command
