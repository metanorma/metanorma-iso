      ...
      .to be_equivalent_to xmlpp(<<~"OUTPUT")
        ...
        <iso-standard type="semantic" version="#{Metanorma::ISO::VERSION}" xmlns="https://www.metanorma.org/ns/iso">
          <bibdata type="standard">
            ...
            <docidentifier type="iso-reference">ISO/WD 1000-1.3:2000(en)</docidentifier>
            ...
            <docidentifier type="iso-with-lang">ISO/WD 1000-1.3(E)</docidentifier>
            ...
            <ext>
              ...
              <stagename abbreviation="WD">Working Draft</stagename>
            </ext>
          </bibdata>
          <sections/>
        </iso-standard>
             ...
             <approvalgroup>
              <agency>ISO</agency>
               ...
               <workgroup number='3' type='WG'>WG</workgroup>
                    ...
                    <stagename abbreviation="TR">International Standard Technical Report</stagename>
                  </ext>
                </bibdata>
                <sections/>
              </iso-standard>
  ...
  it "defaults metadata for DIR" do
    ...
    expect(xmlpp(output.sub(%r{<boilerplate>.*</boilerplate>}m, "")))
      .to be_equivalent_to xmlpp(<<~"OUTPUT")
        <iso-standard xmlns="https://www.metanorma.org/ns/iso"  type="semantic" version="#{Metanorma::ISO::VERSION}">
          <bibdata type='standard'>
            <docidentifier type='ISO'>ISO DIR 1000:2022</docidentifier>
            <docidentifier type='iso-reference'>ISO DIR 1000:2022(en)</docidentifier>
            <docidentifier type='URN'>urn:iso:doc:iso:dir:1000:2022</docidentifier>
            <docidentifier type='iso-undated'>ISO DIR 1000</docidentifier>
            <docidentifier type='iso-with-lang'>ISO DIR 1000:2022(E)</docidentifier>
            <docnumber>1000</docnumber>
            <contributor>
              <role type='author'/>
              <organization>
            ...
            <approvalgroup>
             <agency>ISO</agency>
              ...
              <stagename abbreviation="DIR">International Standard</stagename>
            </ext>
          </bibdata>
          <sections> </sections>
        </iso-standard>
               ...
               <relation type='instance'>
                 <bibitem type='standard'>
                   ...
                   <abstract format='text/plain' language='fr' script='Latn'>
                     ...
                     concentré de caoutchouc naturel et le latex de caoutchouc
                     synthétique. Ces méthodes ne conviennent pas nécessairement au
                     latex d’origine naturelle autre que celui de l’Hevea brasiliensis,
                     au latex vulcanisé, aux mélanges de latex, ou aux dispersions
