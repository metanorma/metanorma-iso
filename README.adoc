...
** Microsoft Word output, following the conventions of the ISO Standard
Microsoft Word template. (In development)
** PDF (forthcoming)
** HTML (forthcoming)
...
WARNING: The current RNG model of ISO XML is out of sync with the UML.
...
TODO: The gem will then convert the XML to Word Document, HTML, and PDF,
and output those files with the appropriate file suffixes. 
`lib/asciidoctor/iso/iso2wordhtml.rb` is work in progress, and not yet
...
image::diagrams/Document__Standard Document_2.png[]

=== Bibliographic Models

image::diagrams/Document__Bibliographic Items_1.png[]

=== Terms and References Model

image::diagrams/Document__Terms Of Reference_3.png[]

=== Text Section Model

image::diagrams/Document__Section_5.png[]

=== Text Block Model

image::diagrams/Document__Blocks_4.png[]

=== Text Model

image::diagrams/Document__Text_0.png[]
...
* the link:spec/examples/rice.html[AsciiISO rendering of the Rice document as an HTML preview] 
(native Asciidoc rendering)
* the link:spec/examples/rice.xml[ISO XML rendering of the Rice document].
* the link:spec/examples/rice.xml.doc[Word .doc rendering of the Rice document] (Work in progress).
