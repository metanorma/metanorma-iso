...
* _Crossreferences_: Footnoted crossreferences are indicated with the reference text `fn` in isolation, or `fn:` as a prefix to the reference text. The default HTML processor leaves these as is.
...
`:title-intro`:: The introductory component of the title of the document
`:title-main`:: The main component of the title of the document (mandatory). (The first line of the Asciidoc document, which contains the title introduced with `=`, is ignored)
