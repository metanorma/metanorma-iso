...
To author Asciidoctor documents for Metanorma, you need to be familiar with the Asciidoctor syntax, as well as the Metanorma Asciidoctor extensions to the syntax and conventions, including extensions specific to the standards class: 
